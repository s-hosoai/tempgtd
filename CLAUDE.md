...
- [] 定例タスクの導入．毎週火曜15時・毎月第3月曜16時といったように定期的にNextAction, およびタイムテーブルに追加されるタスク．
- [] タイムテーブルに割り当てられたタスクは，時間が過ぎると自動的に完了するものと，NextActionとして残り続けるものを設定できるようにする
- [] タスク詳細，メモ機能
- [] Ideaタスク・プロジェクト．まだタスクになっていない思いついたもの．Ideaビューを作成する．見直しのタイミングで再度見直す
