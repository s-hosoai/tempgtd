...
export function GlobalCapture() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-white border-t-2 border-gray-200 shadow-lg z-50">
      {/* Current タスク行 */}
      <div className="px-6 pt-3 pb-2 flex items-center gap-3 border-b border-gray-100">
        ...
        {currentTask ? (
          <>
            ...
            <select
              ...
              className="text-xs px-2 py-1 border rounded-lg bg-white focus:outline-none focus:ring-1 focus:ring-blue-400 shrink-0"
            >
      ...
      {/* Capture 入力行 */}
      <form onSubmit={handleSubmit} className="px-6 py-3 flex items-center gap-4">
        <input
          ref={inputRef}
          value={title}
        ...
        <button
          ...
          className="shrink-0 px-5 py-2.5 bg-blue-600 text-white text-sm font-medium rounded-xl hover:bg-blue-700 disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
        >
          追加
        </button>
      </form>
